...
namespace SweetShop.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InvoiceID,OrderID,InvoiceDate,TotalAmount")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceID,OrderID,InvoiceDate,TotalAmount")] Invoice invoice)
        {
