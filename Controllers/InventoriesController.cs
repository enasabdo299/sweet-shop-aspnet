...
namespace SweetShop.Controllers
{
    public class InventoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InventoryID,ProductID,StockQuantity,LastUpdated")] Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventoryID,ProductID,StockQuantity,LastUpdated")] Inventory inventory)
        {
